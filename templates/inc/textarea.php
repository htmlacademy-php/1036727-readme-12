...
<div class="<?= esc($input['form']) ?>__textarea-wrapper form__textarea-wrapper<?= $classname ?>">
    ...
    <div class="form__input-section">
        <textarea class="<?= esc($input['form']) ?>__textarea form__textarea form__input" id="<?= esc($input['name']) ?>" name="<?= esc($input['name']) ?>" placeholder="<?= esc($input['placeholder']) ?>"><?= get_post_value($input['name']) ?></textarea>
