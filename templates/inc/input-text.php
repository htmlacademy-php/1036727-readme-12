...
<div class="<?= esc($input['form']) ?>__input-wrapper form__input-wrapper<?= $classname ?>">
    ...
    <div class="form__input-section">
        <input class="<?= esc($input['form']) ?>__input form__input" id="<?= esc($input['name']) ?>" type="<?= esc($input['type']) ?>" name="<?= esc($input['name']) ?>" value="<?= get_post_value($input['name']) ?>" placeholder="<?= esc($input['placeholder']) ?>">
