                        ...
                        <div class="messages__avatar-wrapper">
                            <?php if (!empty($contact['avatar_path'])): ?>
                                <img style="width: 60px; height: 60px; object-fit: cover;"
                                    class="messages__avatar" src="uploads/<?= esc($contact['avatar_path']) ?>" width="60" height="60" alt="Аватар пользователя">
                            <?php endif; ?>
                                            ...
                                            <div class="messages__item-avatar">
                                                <?php if (!empty($message['avatar_path'])): ?>
                                                    <img style="width: 40px; height: 40px; object-fit: cover;"
                                                        class="messages__avatar" src="uploads/<?= esc($message['avatar_path']) ?>" width="40" height="40" alt="Аватар пользователя">
                                                <?php endif; ?>
                                            </div>
                                        </a>
