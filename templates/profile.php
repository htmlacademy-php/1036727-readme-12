                ...
                <div class="profile__avatar user__avatar">
                    <?php if (!empty($user['avatar_path'])): ?>
                        <img style="width: 100px; height: 100px; object-fit: cover;"
                            class="profile__picture user__picture" src="uploads/<?= esc($user['avatar_path']) ?>" width="100" height="100" alt="Аватар пользователя">
                    <?php endif; ?>
                </div>
            ...
            <div class="profile__tabs filters">
                ...
                <ul class="profile__tabs-list filters__list tabs__list">
                    <li class="profile__tabs-item filters__item">
                        ...
                        <?php $url = isset($_GET['tab']) && $_GET['tab'] === 'posts' ? '#' : "/profile.php?id={$user_id}&tab=posts"; ?>
                    ...
                    <li class="profile__tabs-item filters__item">
                        ...
                        <?php $url = isset($_GET['tab']) && $_GET['tab'] === 'likes' ? '#' : "/profile.php?id={$user_id}&tab=likes"; ?>
                    ...
                    <li class="profile__tabs-item filters__item">
                        ...
                        <?php $url = isset($_GET['tab']) && $_GET['tab'] === 'subscriptions' ? '#' : "/profile.php?id={$user_id}&tab=subscriptions"; ?>
                                            ...
                                            <div class="post__avatar-wrapper post__avatar-wrapper--repost">
                                                <?php if (!empty($post['origin']['avatar_path'])): ?>
                                                    <img style="width: 60px; height: 60px; object-fit: cover;"
                                                        class="post__author-avatar" src="uploads/<?= esc($post['origin']['avatar_path']) ?>" width="60" height="60" alt="Аватар пользователя">
                                                <?php endif; ?>
                                            </div>
                                    ...
                                    <a class="user__avatar-link" href="/profile.php?id=<?= esc($like['user_id']) ?>&tab=posts">
                                        <div class="post-mini__avatar user__avatar">
                                            <?php if (!empty($like['avatar_path'])): ?>
                                                <img style="width: 60px; height: 60px; object-fit: cover;"
                                                    class="post-mini__picture user__picture" src="uploads/<?= esc($like['avatar_path']) ?>" width="60" height="60" alt="Аватар пользователя">
                                            <?php endif; ?>
                                        </div>
                                    </a>
                                ...
                                <div class="post-mini__user-info user__info">
                                    <a class="user__avatar-link" href="/profile.php?id=<?= esc($user['id']) ?>">
                                        <div class="post-mini__avatar user__avatar">
                                            <?php if (!empty($user['avatar_path'])): ?>
                                                <img style="width: 60px; height: 60px; object-fit: cover;"
                                                    class="post-mini__picture user__picture" src="uploads/<?= esc($user['avatar_path']) ?>" width="60" height="60" alt="Аватар пользователя">
                                            <?php endif; ?>
                                        </div>
                                    </a>
                                    <div class="post-mini__name-wrapper user__name-wrapper">
